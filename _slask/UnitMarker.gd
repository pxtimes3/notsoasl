...
#
		...
		# where am i in relation to camera?
...
func _on_mouse_entered() -> void:
	...
	var myPosition = parent.get_global_position()
	var cameraPosition = camera.get_global_position()
	var cameraDistance = myPosition.y - cameraPosition.y
	print("My marker is: ", parent)
	print("My position is: ", myPosition)
	print("Camera is at: ", cameraPosition)
	print("Distance to camera: ", cameraDistance)
